...
RSpec.describe SchemaMigrator do
  ...
  it "switches the alias to a new index" do
    ...
    described_class.new("govuk_test", search_config, wait_between_task_list_check: 0.2, io: StringIO.new) do |migrator|
      migrator.reindex
  ...
  it "copies data to the new index" do
    ...
    described_class.new("govuk_test", search_config, wait_between_task_list_check: 0.2) do |migrator|
      migrator.reindex
      migrator.switch_to_new_index
    end
