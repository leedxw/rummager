...
RSpec.describe 'ElasticsearchAdvancedSearchTest' do
  ...
  it "escapes lucene characters" do
  ...
  it "allows paging through keyword search" do
  ...
  it "filters results by a property" do
  ...
  it "filters results by a nested property" do
  ...
  it "allows boolean filtering" do
  ...
  it "allows combining all filters" do
  ...
  it "does not expand organisations" do
  ...
  it "allows ordering by properties" do
