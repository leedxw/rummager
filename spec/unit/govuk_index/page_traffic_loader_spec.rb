...
RSpec.describe GovukIndex::PageTrafficLoader do
  before do
    @new_index = instance_double('IndexGroup', :new_index, commit: true, real_name: 'new_index_name')
    @current_index = instance_double('IndexGroup', :current_index, close: true, real_name: '')
  ...
  it 'processes input data in batches of pairs based on the batch size' do
    ...
    loader = described_class.new(iostream_batch_size: 2)
